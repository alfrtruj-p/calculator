...
class Input(models.Model):
    ...
    type = models.CharField(default='digital', max_length=40, choices=TYPE, verbose_name='Type of offline preservation')
    ...
    awa = models.CharField(default='no', max_length=40, choices=DECISION, verbose_name='Storage in Arctic World Archive')
